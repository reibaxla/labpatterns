...
public class PacientSymptomGUI extends JFrame {
	 ...
	 * Create the frame.
	 */
	public PacientSymptomGUI(Observable pazientea) {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		    	...
		    	((Covid19Pacient) pazientea).addSymptomByName(((Symptom)symptomComboBox.getSelectedItem()).getName(),new Integer(weightField.getText()));
		...
		btnRemoveSymptom.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		    	...
		    	((Covid19Pacient) pazientea).removeSymptomByName(((Symptom)symptomComboBox.getSelectedItem()).getName());
		...
		labelPacient.setText(((Covid19Pacient) pazientea).getName());
